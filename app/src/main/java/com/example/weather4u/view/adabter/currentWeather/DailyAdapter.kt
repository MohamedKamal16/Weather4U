package com.example.weather4u.view.adabter.currentWeather
...
class DailyAdapter(var dailyList: ArrayList<DailyItem>,val viewModel: WeatherFragmentViewModel) : RecyclerView.Adapter<DailyAdapter.DailyViewHolder>() {
